...
- **NeroNotes** — part of the Neroland sci-fi Minecraft mod ecosystem, built on **Neroland Core**.
...
- The wiki is **per-mod** — document only NeroNotes here; cross-mod / ecosystem concepts live in the
